...
class Queue():
    ...
    def __init__(self, name, basedir='.', queue_id=0):
        ...
        ### PYTHON2_BEGIN ###  # noqa: E266 - to be removed after migration cleanup
        for name, state in iteritems(states):
        ...
        # for name, state in states.items():  # noqa: E115 - remove this noqa comment after migration cleanup
    ...
    def getstatus(self):
        return self.state_map[self._status]
