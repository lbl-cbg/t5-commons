...
SyntaxHighlighter.brushes.Yaml = function()
{
    ...
    this.regexList = [
        ...
        { regex: /^\s*-\s*([a-z0-9\._-])+\s*:/gmi,					css: 'variable' },		// key
		//{ regex: /\s?(\.)([a-z0-9\._-])+\s?:/gmi,					css: 'comments' },		// section
		{ regex: /\s(@|:)([a-z0-9\._-])+\s*$/gmi,					css: 'variable bold' },	// variable, reference
		//{ regex: /:\s*[a-zA-Z].*$/gmi,					css: 'string' },	// variable, reference
		{ regex: /:.*[a-zA-Z]+.*/gm,								css: 'string' },	// integers
		{ regex: /\s+[0-9\.]+\s?$/gm,								css: 'color2 bold' },	// integers
