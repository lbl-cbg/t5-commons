...
class CSBIDTask:    
    ...
    def run(self):
        ...
        create_record_response = super().create_new_jira_record(
                                    ...
                                    attributes_data_list,
                                    "Attempted Protein Purifications",
                                    "Purbatchcproprcid", 
                                    "purbatchcproprcid")
    ...
    def get_construct_attributes_data(self, data):
        return [
            ...
            {
                    "objectTypeAttributeId": "673",  # Source Lab
                    "objectAttributeValues": [
                        {
                            "value": self.source_lab
                        }
                    ]
            }, 
            {
    ...
    def get_purifiedproteins_attributes_data(self, data):
        return [ 
            ...
            {
                    "objectTypeAttributeId": "571",  # Source Lab
                    "objectAttributeValues": [
                        {
                            "value": self.source_lab
                        }
    ...
    def get_proteininventory_attributes_data(self, data):
        return [ 
            ...
            {
                    "objectTypeAttributeId": "672",  # Source Lab
                    "objectAttributeValues": [
                        {
                            "value": self.source_lab
                        }
    ...
    def get_all_purifiedproteins_attributes_data(self, data):
        ...
        out.append({
                    "objectTypeAttributeId": "671",  # Source Lab
                    "objectAttributeValues": [
                        {
                            "value": self.source_lab
                        }
        ...
        v = False
        if data["purbatchcproprcid"] in self.pur_protein_id_map:
            v = True
        out.append({
                    "objectTypeAttributeId": "570",  # ready
                    "objectAttributeValues": [
                        {
                            "value": v
                        }
    ...
    def get_allcrystalsummary_attributes_data(self, data):
        ...
        out.append({
                    "objectTypeAttributeId": "569",  # Crystallization Harvest ID
                    "objectAttributeValues": [
                        {
